...
!function (e) {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    var e = document.querySelector(".wsu-g-header__more-icon-link");
    void 0 !== e && null != e && e.addEventListener("click", function () {
      console.log("Links toggle -- Coming soon!");
    });
    var t = document.querySelector(".wsu-g-header__search-icon-link");
    void 0 !== t && null != t && t.addEventListener("click", function () {
      console.log("Search toggle -- Coming soon!");
    });
    var n = document.querySelector(".wsu-g-header__menu-icon-link");
    void 0 !== n && null != n && n.addEventListener("click", function (e) {
      window.vertical_nav.togglePanel(e);
    }), document.addEventListener("scroll", function () {
      setTimeout(function () {
        document.body.scrollTop > 30 ? document.body.classList.add("wsu-g-header--is-hidden") : document.body.classList.remove("wsu-g-header--is-hidden");
      }, 100);
    });
  });
}, function (e, t, n) {}, function (e, t) {}, function (e, t, n) {}, function (e, t) {}, function (e, t, n) {}, function (e, t, n) {}, function (e, t, n) {}, function (e, t) {}, function (e, t, n) {}, function (e, t, n) {}, function (e, t) {}, function (e, t, n) {}, function (e, t, n) {}, function (e, t) {}, function (e, t, n) {}, function (e, t) {}, function (e, t, n) {}, function (e, t, n) {
  "use strict";
  ...
  var h = function () {
    function e(t) {
      !function (e, t) {
        if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
      }(this, e), this.breakpoints = [], this.main_nav_width = null, this.params = t, this.screenWidth = null, this.window = window, document.emitter = l();
    }
    ...
    return t = e, (n = [{
      ...
      value: function value() {
        var e = this;
        this.update_nav(), window.addEventListener("resize", this.update_nav.bind(this)), document.addEventListener("DOMContentLoaded", function () {
          document.emitter.on("wsu-vertical-nav--after-open", e.update_nav.bind(e)), document.emitter.on("wsu-vertical-nav--after-close", e.update_nav.bind(e));
        });
      }
    }, {
      key: "update_nav",
      value: function value() {
        ...
        document.fonts.ready.then(function () {
          null == e.get_priority_nav && e.get_frame_width <= e.get_main_nav_width && e.create_priority_nav(), null != e.get_priority_nav && e.resize_nav(), e.initiateKeyboardNavigationSupport(), e.initiateAriaExpanded();
        });
      }
    }, {
      ...
      key: "calculateWidths",
      value: function value() {
        this.main_nav_width = this.get_main_nav_width, this.screenWidth = this.get_frame_width;
      }
    }, {
      ...
      key: "get_frame_width",
      get: function get() {
        return document.querySelector(".wsu-s-nav-horizontal__nav-container").offsetWidth;
      }
    }, {
      key: "get_main_nav_width",
      get: function get() {
        return document.querySelector(this.params.main_nav_selector).offsetWidth;
      }
    }, {
      key: "get_main_nav",
      get: function get() {
      ...
      get: function get() {
        return document.querySelector("." + this.params.priority_nav_list_item_class_name);
      }
    }, {
      key: "get_priority_nav_submenu",
      get: function get() {
        return document.querySelector("." + this.params.priority_nav_list_item_list_class_name);
      }
    }, {
      key: "getBreakpoints",
      get: function get() {
      ...
      d = document.querySelector(".wsu-s-nav-horizontal__wrapper");

  void 0 !== d && null != d && (d.classList.remove("wsu-u-no-js"), new h({
  ...
  var f = function () {
    ...
    return t = e, (n = [{
      ...
      value: function value() {
        ...
        }), document.emitter.on("wsu-vertical-nav--after-open", this.panelOpened.bind(this)), this.nav_panel.classList.contains("wsu-s-nav-vertical__wrapper--open") && this.openPanel();
      }
    }, {
      ...
      key: "openPanel",
      value: function value() {
        this.nav_panel_control.setAttribute("aria-expanded", "true"), this.nav_panel.classList.add("wsu-s-nav-vertical__wrapper--open"), document.emitter.emit("wsu-vertical-nav--open"), console.log("Event emitted: wsu-vertical-nav--open"), setTimeout(function () {
          document.emitter.emit("wsu-vertical-nav--after-open"), console.log("Event emitted: wsu-vertical-nav--after-open");
        }, 600), this.body.classList.add("wsu-s-nav-vertical__nav--is-open");
      }
    }, {
      key: "close",
      value: function value(e) {
      ...
      key: "closePanel",
      value: function value() {
        this.nav_panel_control.setAttribute("aria-expanded", "false"), this.nav_panel.classList.remove("wsu-s-nav-vertical__wrapper--open"), document.emitter.emit("wsu-vertical-nav--close"), console.log("Event emitted: wsu-vertical-nav--close"), setTimeout(function () {
          document.emitter.emit("wsu-vertical-nav--after-close"), console.log("Event emitted: wsu-vertical-nav--after-close");
        }, 600), this.body.classList.remove("wsu-s-nav-vertical__nav--is-open");
      }
    }, {
      key: "toggle",
      value: function value(e) {
      ...
      key: "togglePanel",
      value: function value(e) {
        e.preventDefault(), "true" == this.nav_panel_control.getAttribute("aria-expanded") ? this.closePanel() : this.openPanel();
      }
    }, {
      key: "panelOpened",
      value: function value() {
        ...
        var o = document.querySelector(".wsu-g-header__wrapper");
        void 0 !== o && null != o && document.body.classList.remove("wsu-g-header--is-hidden");
      }
    }]) && v(t.prototype, n), i && v(t, i), e;
  }(),
      _ = document.querySelector(".wsu-s-nav-vertical__wrapper");

  void 0 !== _ && null != _ && (_.classList.remove("wsu-u-no-js"), window.vertical_nav = new f({
  ...
  }), window.vertical_nav.init(), document.querySelector(".wsu-s-nav-vertical__nav-container-close-link").addEventListener("click", function (e) {
    e.preventDefault(), window.vertical_nav.closePanel();
  }));
