	...
	if ( baseDecorators.includes( props.type ) ) {
		...
		return (
			<span 
				...
				style={ decoratorStyle }
			>
				<svg role="img" className="wsu-g-header__logo-svg" enableBackground="new 0 0 70.2 69.6" version="1.1" viewBox="0 0 70.2 69.6" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" aria-label="WSU Cougar Head Logo">
		...
		return (
			<span 
				...
				style={ decoratorStyle }
			>
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 579.216 843.63" aria-label="WSU Letters as Watermark">
