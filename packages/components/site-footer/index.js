			...
			<footer className="wsu-s-footer__container">
				...
				<div className="wsu-s-footer__contact-container">
					<p className="wsu-s-footer__contact-info">
						...
						<span className="wsu-s-footer__contact-phone">
							<WsuLink isSecondary href="tel:509-123-4567" className="wsu-s-footer__contact-phone__link">P 509-123-4567</WsuLink>
						</span> 
						<span className="wsu-s-footer__contact-fax">
							<WsuLink isSecondary  href="tel:509-123-4567">F 509-123-4567</WsuLink>
						</span>
					</p>
