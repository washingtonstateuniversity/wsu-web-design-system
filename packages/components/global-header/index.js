		...
		<div className="wsu-g-header__wrapper wsu-u-no-js">
			<header className="wsu-g-header">
				...
				<nav className="wsu-g-header__nav" aria-label="Global Header Call to Action Links">
					<button className="wsu-g-header__more-icon-link" onClick={toggleMoreMenu}>
						<span className="wsu-icon wsu-i-more"></span>
					</button>
					<ul className="wsu-g-header__nav-list">
						<li className="wsu-g-header__nav-item">
							<a className="wsu-g-header__nav-link" href="https://foundation.wsu.edu/">Give</a>
						</li>
						<li className="wsu-g-header__nav-item">
							<a className="wsu-g-header__nav-link" href="https://admission.wsu.edu/apply/as/find-your-application/">Apply Now</a>
						</li>
						<li className="wsu-g-header__nav-item">
							<a className="wsu-g-header__nav-link" href="https://wsu.edu/about/statewide/">Locations</a>
						</li>
						<li className="wsu-g-header__nav-item">
							<a className="wsu-g-header__nav-link" href="https://mywsu.wsu.edu/">MyWSU</a>
						</li>
					</ul>
				</nav>
