...
const GlobalHeader = ( props ) => {
	...
	return (
		<div className="wsu-g-header__wrapper wsu-u-no-js">
			<header className="wsu-g-header">
				<a className="wsu-g-header__logo-link" href="#">
					<span className="wsu-g-header__logo-icon">
						<svg role="img" aria-labelledby="wsuLogoTitle wsuLogoDesc" className="wsu-g-header__logo-svg" enable-background="new 0 0 70.2 69.6" version="1.1" viewBox="0 0 70.2 69.6" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg">
					...
					<span className="wsu-g-header__logo-text">Washington State University</span>
				</a>
				<nav className="wsu-g-header__nav" aria-label="Global Header Call to Action Links">
					<a className="wsu-g-header__more-icon-link" href="#">
						<span className="wsu-icon wsu-i-more"></span>
					</a>
					<ul className="wsu-g-header__nav-list">
						<li className="wsu-g-header__nav-item">
							<a className="wsu-g-header__nav-link" href="#">Give</a>
						</li>
						<li className="wsu-g-header__nav-item">
							<a className="wsu-g-header__nav-link" href="#">Apply Now</a>
						</li>
						<li className="wsu-g-header__nav-item">
							<a className="wsu-g-header__nav-link" href="#">Locations</a>
						</li>
						<li className="wsu-g-header__nav-item">
							<a className="wsu-g-header__nav-link" href="#">MyWSU</a>
						</li>
					</ul>
				</nav>
				<div className="wsu-g-header__search-icon-container">
					<a className="wsu-g-header__search-icon-link" href="#" aria-haspopup="true" aria-expanded="true">
